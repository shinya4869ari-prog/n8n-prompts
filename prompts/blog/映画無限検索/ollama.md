...
- **重要（ストーリー限定ルール）**：映画の「ストーリー（あらすじ・物語の展開）」のみを記述してください。映画の評価・レビュー（「賛否両論ある」など）、制作背景や撮影手法（「3時間20分で撮影された」など）、視聴方法や配信・DVD情報（「Amazon Primeで視聴可能」など）といった、純粋なストーリー以外の情報は、検索結果に記載があっても紹介文には絶対に含めないでください。
