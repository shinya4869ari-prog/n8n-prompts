...
## 【③ 物価】
以下の各項目を個別に検索すること。
※ 首都名は事前確認で特定した英語名を使うこと

### ビール（レストラン500ml）
「Numbeo Domestic Beer price 【首都英語名】 latest data」
「Numbeo cost of living 【首都英語名】 beer latest」

### タバコ（マルボロ1箱）
「Numbeo cigarettes Marlboro price 【首都英語名】 latest data」

### ミネラルウォーター（500ml）
「Numbeo water bottle 0.5 liter price 【首都英語名】 latest data」
...
「Numbeo gasoline price 【首都英語名】 latest data」
「{{ $json.countryEn }} petrol price per liter site:globalpetrolprices.com latest」

### 外食（安めの店・1食）
「Numbeo inexpensive restaurant meal price 【首都英語名】 latest data」

### 電気・水道・ガス（月額・85㎡）
「Numbeo utilities monthly cost 85m2 apartment 【首都英語名】 latest data」

### 家賃（1LDK・首都圏市内）
「Numbeo apartment rent 1 bedroom city centre 【首都英語名】 latest data」

### 平均月収（手取り）
「Numbeo average monthly net salary 【首都英語名】 latest data」
