...
首都（日本語）
「{{ $json.countryEn }} capital city in Japanese」
「{{ $json.countryEn }} 首都 日本語」
...
## 【③ 物価】
以下の各項目を個別に検索すること。
※ 首都名は事前確認で特定した名称を使うこと

### ビール（レストラン500ml）
「Domestic Beer (0.5 liter draught) {{ $json.countryEn }} Numbeo latest data」
「beer price {{ $json.countryEn }} 【首都】 city centre latest official data」
...
「mineral water price {{ $json.countryEn }} 【首都】 city latest official data」
...
「cheap meal price {{ $json.countryEn }} 【首都】 city latest official data」

### 電気・水道・ガス（月額・85㎡）
「Numbeo utilities monthly cost (85m2 apartment) {{ $json.countryEn }} latest data」
「electricity water gas monthly bill {{ $json.countryEn }} 【首都】 city latest official data」

### 家賃（1LDK・首都圏市内）
「Numbeo apartment rent 1 bedroom city centre {{ $json.countryEn }} latest data」
「1 bedroom apartment rent {{ $json.countryEn }} 【首都】 city centre latest official data」
