...
ISO3_TO_M49 = {
    ...
    "COD": "180", "COG": "178", "CRC": "188", "CIV": "384", "HRV": "191", "CUB": "192", "CYP": "196",
    "CZE": "203", "DNK": "208", "DJI": "262", "DMA": "212", "DOM": "214", "ECU": "218", "EGY": "818", "SLV": "222",
...
ISO3_TO_JA = {
    ...
    "COD": "コンゴ民主共和国", "COG": "コンゴ共和国", "CRC": "コスタリカ", "CIV": "コートジボワール",
    "HRV": "クロアチア", "CUB": "キューバ", "CYP": "キプロス", "CZE": "チェコ",
    "DNK": "デンマーク", "DJI": "ジブチ", "DMA": "ドミニカ国", "DOM": "ドミニカ共和国", "ECU": "エクアドル",
...
def process_imf_dots(dots_csv_path, target_iso_list=None):
    ...
    eng_name_to_iso3 = {
        ...
        "costa rica": "CRC", "cote d'ivoire": "CIV", "ivory coast": "CIV", "croatia": "HRV", "cuba": "CUB",
