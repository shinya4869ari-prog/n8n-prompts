...
const targetFixed = {
  経済データ: {
    ...
    一人当たりGDP_USD:{ 値: keizai['一人当たりGDP_USD'],年: keizai['一人当たりGDP_USD_年'],出典: keizai['一人当たりGDP_USD_出典'] },
...
const japanFixed = {
  経済データ: {
    ...
    一人当たりGDP_USD:{ 値: jKeizai['一人当たりGDP_USD'],年: jKeizai['一人当たりGDP_USD_年'],出典: jKeizai['一人当たりGDP_USD_出典'] },
...
// --- ライター用プロンプトのデータ埋め込み ---
const writerPromptTemplate = $('PromptLoader').first().json.writer || "";
const finalData = {
  対象国データ: r1,
  対象国データ_記事: r2Merged,
  固定データ: targetFixed,
...
const writerPrompt = writerPromptTemplate.replace(
  /\{\{\s*JSON\.stringify\(\$json\.data\)\s*\}\}/g, 
