...
return [{
  json: {
    ...
    "交通事故死亡率": wb補完(t["交通事故死亡率"]?.["値"], "交通事故死亡率"),
    "交通事故死亡率_年": wb補完年(t["交通事故死亡率"]?.["年"], "交通事故死亡率"),
    "交通事故死亡率_出典": wb補完出典(t["交通事故死亡率"]?.["出典"], "交通事故死亡率"),

    "自殺率": wb補完(t["自殺率"]?.["値"], "自殺率"),
    "自殺率_年": wb補完年(t["自殺率"]?.["年"], "自殺率"),
    "自殺率_出典": wb補完出典(t["自殺率"]?.["出典"], "自殺率"),

    "失業率": item["失業率"] || t["失業率"]?.["値"] || "",
    "失業率_年": item["失業率_年"] || t["失業率"]?.["年"] || "",
    "失業率_出典": item["失業率_出典"] || t["失業率"]?.["出典"] || "",
