...
<h2 style="margin-top:60px;padding-top:20px;border-top:3px solid #00bcd4;">① 制度の9つの皿</h2>
...
<h2 style="margin-top:60px;padding-top:20px;border-top:3px solid #00bcd4;">② 地理と経済の衡量</h2>
...
<p class="citation">出典：World Bank / IMF（各値の年度は表内に記載）</p>

表の下にdata.対象国データ_経済.経済トレンド要約を800文字程度で出力すること。


<h2 style="margin-top:60px;padding-top:20px;border-top:3px solid #00bcd4;">③ 治安と平和の衡量</h2>

<h3>治安指標</h3>

data.固定データ.治安指標 と data.日本固定データ.治安指標 を使って、以下の項目のHTML表を出力すること：

<table style="border-collapse:collapse;width:100%;font-size:14px;margin:20px 0;">
  <thead>
    <tr>
      <th style="border:1px solid #ddd;padding:10px;background:#f0f8f8;text-align:left;">項目</th>
      <th style="border:1px solid #ddd;padding:10px;background:#f0f8f8;text-align:left;">{{ $json.対象国 }}</th>
      <th style="border:1px solid #ddd;padding:10px;background:#f0f8f8;text-align:left;">日本</th>
    </tr>
  </thead>
  <tbody>
    <tr><td style="border:1px solid #ddd;padding:10px;font-weight:bold;">殺人率（10万人あたり）</td><td style="border:1px solid #ddd;padding:10px;">【data.固定データ.治安指標.殺人率.値】（【data.固定データ.治安指標.殺人率.年】・【data.固定データ.治安指標.殺人率.出典】）</td><td style="border:1px solid #ddd;padding:10px;">【data.日本固定データ.治安指標.殺人率.値】</td></tr>
    <tr style="background:#fafafa;"><td style="border:1px solid #ddd;padding:10px;font-weight:bold;">交通事故死亡率（10万人あたり）</td><td style="border:1px solid #ddd;padding:10px;">【data.固定データ.治安指標.交通事故死亡率.値】（【data.固定データ.治安指標.交通事故死亡率.年】・【data.固定データ.治安指標.交通事故死亡率.出典】）</td><td style="border:1px solid #ddd;padding:10px;">【data.日本固定データ.治安指標.交通事故死亡率.値】</td></tr>
    <tr><td style="border:1px solid #ddd;padding:10px;font-weight:bold;">自殺率（10万人あたり）</td><td style="border:1px solid #ddd;padding:10px;">【data.固定データ.治安指標.自殺率.値】（【data.固定データ.治安指標.自殺率.年】・【data.固定データ.治安指標.自殺率.出典】）</td><td style="border:1px solid #ddd;padding:10px;">【data.日本固定データ.治安指標.自殺率.値】</td></tr>
    <tr style="background:#fafafa;"><td style="border:1px solid #ddd;padding:10px;font-weight:bold;">刑務所収容率（10万人あたり）</td><td style="border:1px solid #ddd;padding:10px;">【data.固定データ.治安指標.刑務所収容率.値】（【data.固定データ.治安指標.刑務所収容率.年】・【data.固定データ.治安指標.刑務所収容率.出典】）</td><td style="border:1px solid #ddd;padding:10px;">【data.日本固定データ.治安指標.刑務所収容率.値】</td></tr>
    <tr><td style="border:1px solid #ddd;padding:10px;font-weight:bold;">GPI（世界平和度指数）</td><td style="border:1px solid #ddd;padding:10px;">スコア【data.固定データ.治安指標.GPI.スコア】（【data.固定データ.治安指標.GPI.年】）</td><td style="border:1px solid #ddd;padding:10px;">スコア【data.日本固定データ.治安指標.GPI.スコア】</td></tr>
  </tbody>
</table>
...
```mermaid
xychart-beta
    title "刑務所収容者数の推移 (収容人数)"
    x-axis ["JSONの年を必ず \"2018\", \"2019\" のように引用符付きの文字列でカンマ区切りで列挙すること"]
    y-axis "人数"
    line [【対象国の数値を引用符なしでカンマ区切りで列挙。例: 54000, 53000, 52000】]
    line [【日本の数値を引用符なしでカンマ区切りで列挙。例: 48000, 46000, 44000】]
```
<p class="citation">出典：World Prison Brief / 推移データ（対象国・日本）を元に描画</p>
...
<h2 style="margin-top:60px;padding-top:20px;border-top:3px solid #00bcd4;">④ 貿易の衡量</h2>
...
<h2 style="margin-top:60px;padding-top:20px;border-top:3px solid #00bcd4;">⑤ 生活・価値の衡量（物価比較）</h2>
...
<p class="citation">※算出レート：1 【通貨コード】 = 【為替レート】 JPY（【為替取得日】現在）</p>
<p class="citation">出典：Numbeo, Cost of Living in {{ $json.対象国 }}, {{ $now.toFormat('yyyy年') }}更新 / 日本：Numbeo, Cost of Living in Japan, 2026年更新 / Netflix公式サイト</p>


<h2 style="margin-top:60px;padding-top:20px;border-top:3px solid #00bcd4;">⑥ 歴史的背景（近代100年）</h2>
...
<h2 style="margin-top:60px;padding-top:20px;border-top:3px solid #00bcd4;">⑦ 直近の動向</h2>
