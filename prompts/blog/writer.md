...
日本、中国、韓国の人名は必ず漢字表記を優先すること。カタカナ表記は禁止。
...
あなたはこの {{ $json.対象国 }} (正式な英語名称：{{ $json.対象国 }}) という国を知っていますか？
...
リンクなどは一切貼らず、すべて純粋なテキストで出力してください。
...
| 項目 | {{ $json.対象国 }} | 日本 |
| :--- | :--- | :--- |
| **国家の形と統治機構** | 【data.対象国データ.制度の9つの皿.国家の形と統治機構】 | 【data.日本固定データ.制度の9つの皿.国家の形と統治機構.値】 |
| **行政トップ** | 【data.対象国データ.制度の9つの皿.行政トップ】 | 【data.日本固定データ.制度の9つの皿.行政トップ.値】 |
| **立法と選挙制度** | 【data.対象国データ.制度の9つの皿.立法と選挙制度】 | 【data.日本固定データ.制度の9つの皿.立法と選挙制度.値】 |
| **司法と法制度** | 【data.対象国データ.制度の9つの皿.司法と法制度】 | 【data.日本固定データ.制度の9つの皿.司法と法制度.値】 |
| **社会保障・医療・年金** | 【data.対象国データ.制度の9つの皿.社会保障・医療・年金】 | 【data.日本固定データ.制度の9つの皿.社会保障・医療・年金.値】 |
| **教育制度** | 【data.対象国データ.制度の9つの皿.教育制度】 | 【data.日本固定データ.制度の9つの皿.教育制度.値】 |
| **徴税・財政制度** | 【data.対象国データ.制度の9つの皿.徴税・財政制度】 | 【data.日本固定データ.制度の9つの皿.徴税・財政制度.値】 |
| **安全保障と兵役** | 【data.対象国データ.制度の9つの皿.安全保障と兵役】 | 【data.日本固定データ.制度の9つの皿.安全保障と兵役.値】 |
| **基本権と価値観** | 【data.対象国データ.制度の9つの皿.基本権と価値観】 | 【data.日本固定データ.制度の9つの皿.基本権と価値観.値】 |
...
| 項目 | {{ $json.対象国 }} | 日本 |
| :--- | :--- | :--- |
| **殺人率（10万人あたり）** | 【data.固定データ.治安指標.殺人率.値】（【data.固定データ.治安指標.殺人率.年】） | 【data.日本固定データ.治安指標.殺人率.値】 |
| **交通事故死亡率（10万人あたり）** | 【data.固定データ.治安指標.交通事故死亡率.値】（【data.固定データ.治安指標.交通事故死亡率.年】） | 【data.日本固定データ.治安指標.交通事故死亡率.値】 |
| **自殺率（10万人あたり）** | 【data.固定データ.治安指標.自殺率.値】（【data.固定データ.治安指標.自殺率.年】） | 【data.日本固定データ.治安指標.自殺率.値】 |
| **刑務所収容率（10万人あたり）** | 【data.固定データ.治安指標.刑務所収容率.値】（【data.固定データ.治安指標.刑務所収容率.年】） | 【data.日本固定データ.治安指標.刑務所収容率.値】 |
| **GPI（世界平和度指数）** | スコア【data.固定データ.治安指標.GPI.スコア】 | スコア【data.日本固定データ.治安指標.GPI.スコア】 |
...
xychart-beta
    ...
    x-axis [【JSONにある年をカンマ区切りで"2010"のように引用符を付けずに出力】]
    y-axis "人数"
    line [【対象国の数値をカンマ区切りで出力】]
    line [【日本の数値をカンマ区切りで出力】]
```
