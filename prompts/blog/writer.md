...
5. 結びは必ず「数字と事実（Fact）から、国家の真実を紐解きます」とすること。【導入文】とは書かない。
...
<table style="width:100%; border-collapse:collapse;">
  <thead>
    <tr style="background:#f8f9fa;">
      <th>項目</th><th>{{ $json.対象国 }}</th><th>日本</th>
    </tr>
  </thead>
  <tbody>
    <tr><td>殺人率（10万人あたり）</td><td>【値】（【年】・【出典】）</td><td>【日本の値】</td></tr>
    <tr><td>交通事故死亡率（10万人あたり）</td><td>【値】（【年】・【出典】）</td><td>【日本の値】</td></tr>
    <tr><td>自殺率（10万人あたり）</td><td>【値】（【年】・【出典】）</td><td>【日本の値】</td></tr>
    <tr><td>刑務所収容率（10万人あたり）</td><td>【値】（【年】・【出典】）</td><td>【日本の値】</td></tr>
    <tr><td>GPI（世界平和度指数）</td><td>スコア【スコア】（【年】）</td><td>スコア【日本のスコア】</td></tr>
  </tbody>
</table>
...
data.固定データ.刑務所推移 と data.日本固定データ.刑務所推移 を使って、以下の項目のHTML表を出力すること（※後ほどグラフに自動変換されます）。
厳守事項：JSONデータに存在する年と数値のみ使用すること。学習データで補完・追加禁止。

<table style="width:100%;">
  <thead>
    <tr>
      <th>年</th><th>対象国の収容者数</th><th>年（日本）</th><th>日本の収容者数</th>
    </tr>
  </thead>
  <tbody>
    【JSONにある全年代（1950〜現在）を1行ずつ出力。データがない年は「データなし」と記載】
  </tbody>
</table>
